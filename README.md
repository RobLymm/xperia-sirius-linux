...
| Audio | Partly working | Speakers, earpiece and headphones all work. Speakers are QDSP6 to Quaternary MI2S to two TFA9890 amplifiers; the earpiece is the top TFA9890. Headphones are a WCD9320 codec on SLIMbus, driven by a forward-port of z3ntu's 5.11 driver, with its 9.6 MHz master clock from the PM8941 divider on PMIC GPIO 15. Microphones do not work: the whole capture side of the codec driver is still stubbed. `drivers/audio/wcd9320/`, `drivers/clk/pmic-clkdiv/` |
