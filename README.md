...
| Audio | Partly working | Speakers, earpiece and headphones all work, and the radio app can switch between speaker, headphones and Bluetooth. Speakers are QDSP6 to Quaternary MI2S to two TFA9890 amplifiers; the earpiece is the top TFA9890. Headphones are a WCD9320 codec on SLIMbus with its 9.6 MHz master clock from the PM8941 divider on PMIC GPIO 15. Microphones do not work: the codec half is written and verified, but the DSP refuses to start the SLIMbus capture port. `drivers/audio/wcd9320/`, `drivers/clk/pmic-clkdiv/` |
